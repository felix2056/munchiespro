    ...
    <div>
      ...
      <div class="max-w-6xl px-3 mx-auto text-left">
        <div class="flex flex-wrap p-4">
          <div class="flex flex-col items-center w-full px-4 mb-4 md:w-56">
            <div
              class="flex flex-col justify-center w-48 h-48 mb-4 text-center text-white bg-green-500 rounded-full align-center review-score-background-image"
            >
              <div class="mb-2 text-5xl font-bold">4.7</div>
              <div class="uppercase">From 3163 Reviews</div>
            </div>
            <!---->
          </div>
          <div class="w-full md:flex-1">
            ...
            <div>
              ...
              <span
                ><div
                  class="p-4 mb-4 border rounded-lg shadow-md"
                  style="--index: 0"
                >
                  <div class="flex flex-wrap justify-between mb-4 align-center">
                    <div class="flex">
                      <div class="relative">
                        <img
                          data-cfsrc="/user_images/60x60//user_images/60x60/default.png"
                        ...
                        /><noscript
                          ><img
                            src="/user_images/60x60//user_images/60x60/default.png"
                            alt="Where's Weed user"
                            width="50"
                            height="50"
                            class="border border-gray-300 rounded-full shadow-sm"
                        /></noscript>
                        <img
                          src="fonts/star-full-circled-yellow.0833bb083d0d3a1e3bc6afdc00347b33.svg"
                          width="17"
                          height="17"
                          alt="verified user"
                      ...
                      <div class="flex flex-col justify-center ml-3">
                        <a
                          href="Rooster2187.html"
                          class="text-base font-bold text-black"
                        >
                          Rooster2187
                        </a>
                        <!---->
                        <div class="text-xs">11/11/2021 - 11:16AM</div>
                      </div>
                    </div>
                    <div class="flex align-center"><!----></div>
                  </div>
                  <p class="mb-3 text-left">
                    I’ve ordered from Munchies several times, never had a bad
                    experience! The staff is so friendly, products are amazing
                    and I’m always satisifed! 100 stars all the way 💯
                  </p>
                  <!---->
                  <!---->
                  <!---->
                  ...
                  <div class="flex justify-between">
                    <div class="flex">
                      <button class="flex items-center">
                        <img
                          src="fonts/thumbs-up.4c9c88acdca409411f39bc1ba5550950.svg"
                          alt="thumbs up"
                          class="w-4 h-4"
                        />
                      ...
                      <button class="flex items-center ml-4">
                        <img
                          src="fonts/thumbs-down.247df3307673f5feadd11af35de80388.svg"
                          alt="thumbs down"
                          class="w-4 h-4"
                        />
                  ...
                  <div class="flex flex-wrap justify-between mb-4 align-center">
                    <div class="flex">
                      ...
                      <div class="flex flex-col justify-center ml-3">
                        ...
                        <!---->
                        <div class="text-xs">12/16/2021 - 2:50PM</div>
                      </div>
                    </div>
                    <div class="flex align-center"><!----></div>
                  </div>
                  <p class="mb-3 text-left">
                    Munchies is excellent and my go to provider since moving to
                    DC. They are always extremely quick to respond and offer
                    competitive deals for a superior products. I buy from
                    Munchies bi-Monthly and have never been disappointed in the
                    quality of their products. The only negative experience I
                    have had is that their delivery time was once too quick and
                    I was stuck on a call, unable to meet my driver immediately,
                    but they came back within 15 minutes to fulfill my order.
                    10/10 service.
                  </p>
                  <!---->
                  <!---->
                ...
                <div class="p-4 mb-4 border rounded-lg shadow-md">
                  <div class="flex flex-wrap justify-between mb-4 align-center">
                    <div class="flex">
                      ...
                      <div class="flex flex-col justify-center ml-3">
                        <a
                          href="ashkash1290.html"
                          class="text-base font-bold text-black"
                        >
                          ashkash1290
                        </a>
                        <!---->
                        <div class="text-xs">12/12/2021 - 12:59PM</div>
                      </div>
                    </div>
                    <div class="flex align-center"><!----></div>
                  </div>
                  <p class="mb-3 text-left">
                    I love this provider. They are courteous and prompt. This is
                    a business that is run professionally. They make certain
                    that confirmations are done via phone call and text and are
                    very flexible for those of us that do not live in the DC
                    area. They’re customer service shows that they care about
                    retaining their consumer base and their product is
                    consistent. Been ordering from them for about 6 months now
                    and have now made them my personal faves!
                  </p>
                  <!---->
                  <!---->
                  <!---->
                  ...
                  <div class="flex flex-wrap justify-between mb-4 align-center">
                    <div class="flex">
                      ...
                      <div class="flex flex-col justify-center ml-3">
                        ...
                        <!---->
                        <div class="text-xs">12/4/2021 - 1:14PM</div>
                      </div>
                    </div>
                    <div class="flex align-center"><!----></div>
                  </div>
                  <p class="mb-3 text-left">
                    They have all of my favorite strains and they're very
                    reasonable prices. They responded to my request ASAP which I
                    loved. I have had to wait around all day for other companies
                    to answer my requests but not Munchies! I will be coming
                    here again.
                  </p>
                  <!---->
                  <!---->
                  ...
                  <div class="flex flex-wrap justify-between mb-4 align-center">
                    <div class="flex">
                      ...
                      <div class="flex flex-col justify-center ml-3">
                        ...
                        <!---->
                        <div class="text-xs">12/2/2021 - 8:22PM</div>
                      </div>
                    </div>
                    <div class="flex align-center"><!----></div>
                  </div>
                  <p class="mb-3 text-left">
                    Incredible prices, phenomenal service, top notch quality. If
                    you're in D.C. and copping elsewhere, wtf are you doing?
                    Munchies ftw - best buds in town
                  </p>
                  <!---->
                  <!---->
                  <!---->
                ...
                <div class="p-4 mb-4 border rounded-lg shadow-md">
                  <div class="flex flex-wrap justify-between mb-4 align-center">
                    <div class="flex">
                      ...
                      <div class="flex flex-col justify-center ml-3">
                        <a
                          href="Ronburgandy.html"
                          class="text-base font-bold text-black"
                        >
                          Ronburgandy
                        </a>
                        <!---->
                        <div class="text-xs">4/8/2022 - 1:59PM</div>
                      </div>
                    </div>
                    <div class="flex align-center"><!----></div>
                  </div>
                  <p class="mb-3 text-left">Good price.</p>
                  <span
                    class="px-2 py-1.5 text-xs font-bold text-green-500 uppercase bg-green-100 border-2 border-green-500 rounded-sm"
                  >
                    Verified Purchase
                  </span>
                  <!---->
                ...
                <div class="p-4 mb-4 border rounded-lg shadow-md">
                  <div class="flex flex-wrap justify-between mb-4 align-center">
                    <div class="flex">
                      ...
                      <div class="flex flex-col justify-center ml-3">
                        <a
                          href="Ww20202020.html"
                          class="text-base font-bold text-black"
                        >
                          Ww20202020
                        </a>
                        <!---->
                        <div class="text-xs">4/8/2022 - 1:34PM</div>
                      </div>
                    </div>
                    <div class="flex align-center"><!----></div>
                  </div>
                  <p class="mb-3 text-left">
                    Have ordered from Munchies four times now and have never had
                    an issue with the product. Great pricing too!
                  </p>
                  <!---->
                  <!---->
                  <!---->
                  ...
                  <div class="flex flex-wrap justify-between mb-4 align-center">
                    <div class="flex">
                      ...
                      <div class="flex flex-col justify-center ml-3">
                        ...
                        <!---->
                        <div class="text-xs">4/8/2022 - 9:31AM</div>
                      </div>
                    </div>
                    <div class="flex align-center"><!----></div>
                  </div>
                  <p class="mb-3 text-left">
                    Great service very nice and good quality bud an wax
                  </p>
                  <span
                    class="px-2 py-1.5 text-xs font-bold text-green-500 uppercase bg-green-100 border-2 border-green-500 rounded-sm"
                  >
                  ...
                  <div class="flex flex-wrap justify-between mb-4 align-center">
                    <div class="flex">
                      ...
                      <div class="flex flex-col justify-center ml-3">
                        ...
                        <!---->
                        <div class="text-xs">4/7/2022 - 6:10PM</div>
                      </div>
                    </div>
                    <div class="flex align-center"><!----></div>
                  </div>
                  <p class="mb-3 text-left">
                    Wonderful customer and good quality bud
                  </p>
                  <span
                    class="px-2 py-1.5 text-xs font-bold text-green-500 uppercase bg-green-100 border-2 border-green-500 rounded-sm"
                  >
                  ...
                  <div class="flex flex-wrap justify-between mb-4 align-center">
                    <div class="flex">
                      ...
                      <div class="flex flex-col justify-center ml-3">
                        ...
                        <!---->
                        <div class="text-xs">4/3/2022 - 4:30PM</div>
                      </div>
                    </div>
                    <div class="flex align-center"><!----></div>
                  </div>
                  <p class="mb-3 text-left">
                    Can’t stress enough how awesome they are!! BEST IN DC!!
                    Can’t wait for them to expand to the DMV!!
                  </p>
                  <!---->
                  <!---->
                  <!---->
